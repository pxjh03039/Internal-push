...
class UpdateScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final viewModel = context.watch<UpdateViewModel>();

    return Scaffold(
      appBar: AppBar(title: const Text('푸시 수정')),
        ...
        child: Column(
          children: [
            ...
            SmallTextButtonGroup(
              ...
              selectedTarget: viewModel.updateState.selectedTarget,
            ...
            SmallTextButtonGroup(
                ...
                selectedTarget: viewModel.updateState.selectedRepeat,
                onChanged: (String value) {
            ...
            /// 요일 선택 (weekly 때만 표시)
            if (viewModel.updateState.selectedRepeat == 'weekly') ...[
              const Align(
                alignment: Alignment.centerLeft,
              ...
              Align(
                ...
                child: SingleChildScrollView(
                  ...
                  child: SmallMultiSelectButtonGroup(
                    ...
                    selectedValues: viewModel.updateState.selectedDays,
            ...
            Row(
              children: [
                ...
                OutlinedButton(
                  ...
                  onPressed: () async {
                    final picked = await datePicker(
                      context: context,
                      initialDate: viewModel.updateState.startDate!,
                    );
                  ...
                  child: Text(
                    "${viewModel.updateState.startDate}".split(' ')[0],
                ...
                if (viewModel.updateState.selectedRepeat == 'daily' ||
                    viewModel.updateState.selectedRepeat == 'weekly') ...[
                  Text(
                    " ~ ",
                    style: TextStyles.mediumTextBold
                        .copyWith(color: ColorStyle.black),
                  ...
                  OutlinedButton(
                    ...
                    child: Text(
                      "${viewModel.updateState.endDate}".split(' ')[0],
                      style: TextStyles.mediumTextBold
                          .copyWith(color: ColorStyle.black),
                    ),
                  ),
            ...
            BigButton(
              ...
              onPressed: () async {
                try {
                  await viewModel.updatePushSchedule();
                  if (context.mounted) {
