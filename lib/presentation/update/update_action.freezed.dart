...
/// @nodoc
mixin _$UpdateAction<T> {
  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UpdateAction<T>);
  }
...
/// @nodoc
class $UpdateActionCopyWith<T, $Res> {
  $UpdateActionCopyWith(UpdateAction<T> _, $Res Function(UpdateAction<T>) __);
}

/// @nodoc

class Success<T> implements UpdateAction<T> {
  Success(this.data);
  ...
  @override
  String toString() {
    return 'UpdateAction<$T>.success(data: $data)';
  }
}

/// @nodoc
abstract mixin class $SuccessCopyWith<T, $Res>
    implements $UpdateActionCopyWith<T, $Res> {
...
class Error<T> implements UpdateAction<T> {
  Error(this.e);
  ...
  @override
  String toString() {
    return 'UpdateAction<$T>.error(e: $e)';
  }
}
